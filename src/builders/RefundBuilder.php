...
class RefundBuilder
{
    ...
    dd('Start creating refund builder tests');
     ...
     * @param  Model  $product
     * @param  int  $quantity
     * @return Refund|stdClass
     *
     * @throws InvalidSquareOrderException
     * @throws MissingPropertyException
     */
    public function addRefundFromModel(Model $order, Model $product, int $quantity): Refund|stdClass
    {
        try {
            ...
            $productCopy = $this->createRefundFromModel($product, $order, $quantity);
     ...
     * @throws MissingPropertyException
     */
    public function addRefundFromArray(stdClass $orderCopy, Model $order, array $product, int $quantity): Refund|stdClass
    {
        try {
            // Get quantity
            $tempQuantity = null;
            ...
            $productCopy = $this->createRefundFromArray($product, $order);
            // Create taxes Collection
            $productCopy->discounts = collect([]);
            //Discounts
     ...
     * @throws MissingPropertyException
     */
    public function createRefundFromArray(array $product, Model $order = null): Refund|stdClass
    {
     ...
     * @throws MissingPropertyException
     */
    public function createRefundFromModel(Model $product, Model $order = null, int $quantity = null): Refund|stdClass
    {
        $productObj = new stdClass();
        //If product doesn't have quantity in pivot table
        //throw new exception because every product should
